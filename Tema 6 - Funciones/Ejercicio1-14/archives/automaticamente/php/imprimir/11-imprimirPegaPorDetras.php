    ...
    switch ($estado) {
        ...
        case "11":
            ...
            if ($input2 == 0) {
                ...
                $mensajeError .= "<span $verde>el numero $input1 menos $input2 $digitoS es: " . pegaPorDelante($input1, $input2) . ".</span>";
                $mensajeError .= crearTabla((pegaPorDelante($input1, $input2)), 1);
            }
            $mensajeError .= "</div>";
            break;
        default:
